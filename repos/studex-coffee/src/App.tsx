      ...
      <nav className="flex items-center justify-between px-8 py-5 border-b border-stone-800 bg-stone-950/90 backdrop-blur sticky top-0 z-50">
        ...
        <div className="flex gap-6 text-sm text-stone-400">
          ...
          <a href="#contact" className="hover:text-amber-400 transition">Contact</a>
                    <a href="/b2b" className="px-3 py-1 bg-emerald-700 hover:bg-emerald-600 text-emerald-300 rounded-md transition text-xs font-medium">B2B SA & UAE</a>
          <a href="/ciie2026" className="px-3 py-1 bg-red-800 hover:bg-red-700 text-red-300 rounded-md transition text-xs font-semibold border border-red-700">🇨🇳 CIIE China</a>
        </div>
      </nav>
